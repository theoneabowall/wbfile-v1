# SPECIAL THANKS TO @watchdog_bots @erotixe @sd_bots FOR MODIFYING THESE AMAZING CODES 
...
async def ai_generate(client, message):
    ...
    if user_input.lower() in ["who is your owner", "what is your owner name"]:  
        buttons = [[
            InlineKeyboardButton("ɢʀᴏᴜᴘ", url="https://t.me/watch_dogs_support")
        ]]
...
async def ai_generate_private(client, message):
  buttons = [[
    InlineKeyboardButton("ᴜsᴇ ɪɴ ɢʀᴏᴜᴘ", url="https://t.me/watch_dogs_support")
  ]]
  reply_markup = InlineKeyboardMarkup(buttons)
  await message.reply_sticker("CAACAgUAAxkBAAEBVPFlqURKlcRL5gwsCr_95NUy1yomWAACbQgAAqkDGFZZit7uxEySIh4E")
