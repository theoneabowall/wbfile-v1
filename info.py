...
API_ID = int(environ.get('API_ID', '21136840'))
API_HASH = environ.get('API_HASH', '0f2ff6ef89fcd5ba226c3f40342f5319')
OWNER_ID = environ.get('OWNER_ID', '6719882299')
BOT_TOKEN = environ.get('BOT_TOKEN', "6929065058:AAE8EGFOz8BucVzw0rk5EGJWnAH_cYIqWfk")
...
OWNER_USERNAME = environ.get('OWNER_USERNAME', 'Pere_dude') # owner username without @

# Admins, Channels & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6729119686 6300311908 5844555402 6346353190 6756246365').split()]
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002050230006') #Channel / Group Id for force sub ( make sure bot is admin )
auth_grp = environ.get('AUTH_GROUP')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1001659445399') # support group id ( make sure bot is admin )
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://cluster0:cluster0@cluster0.cdbv5ys.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
BOT_USERNAME = environ.get("BOT_USERNAME", "PCAutoFilterbot")
BOT_NAME = environ.get("BOT_NAME", "𝐉𝐨𝐤𝐞𝐫")
BOT_ID = environ.get("BOT_ID", "6929065058")
S_GROUP = environ.get('S_GROUP', "watch_dogs_support")
S_CHANNEL = environ.get('S_CHANNEL', "watchdog_bots")
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/wd_link')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/watchdog_bots')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/HowToDownIoadLink/32') # Tutorial video link for opening shortlink website 
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', 'ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ :ᴡᴀᴛᴄʜᴅᴏɢ ʙᴏᴛ')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002113853127')) #Log channel id ( make sure bot is admin )
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/watch_dogs_support') #Support group link ( make sure bot is admin )
...
FQDN = str(getenv('FQDN', BIND_ADRESS)) if not ON_HEROKU or getenv('FQDN') else APP_NAME+'https://pcautofilterbot-8bcc78d7d1cf.herokuapp.com'
